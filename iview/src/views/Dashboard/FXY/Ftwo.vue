                   ...
                   <Col span="16" style="padding:5px 20px 30px 20px;">
                    ...
                    <Col span="8" >
                      <div class="Turnover" style="padding:10px 20px 20px 70px">
                        <div style="font-size: 14px;color:black;margin-bottom: 20px" >门店销售额排名</div>
                        <ul >
                        <li v-for="(value,index) in ranking" :key="index" style="margin-bottom: 10px">
    ...
    methods:{
       fun(i){
        ...
        drawChart() {
            ...
            let myChart13 = this.$echarts.init(document.getElementById("main"));
            // 指定图表的配置项和数据
            let option13 = {
                color: ['#3398DB'],
                title: {
        ...
        drawChart897() {
            // 基于准备好的dom，初始化echarts实例
            let myChart123 = this.$echarts.init(document.getElementById("mainn"));
            // 指定图表的配置项和数据
            let option123 = {
                color: ['#3398DB'],
                title: {
