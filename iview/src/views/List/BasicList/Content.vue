    ...
    <div>
        <div class="bztables">
            <div class="in">
                    ...
                    <div>
                        <div style="display: inline-block">
                            <RadioGroup  type="button">
                                ...
                                <Radio label="default">进行中</Radio>
                                <Radio label="small">等待中</Radio>
                            </RadioGroup>
                        </div>
                ...
                <div class="bzadd" >
                    <span style="font-size: 14px"><Icon type="md-add" size="20" class="ico" color="#333"/>添加</span>
                </div>
                <div class="bzlist">
                    <ul>
                        <li v-for="(value,index) in bzdata" :key="index">
                            <div class="item">
                                ...
                                <Row>
                                    ...
                                    <Col span="11">
                                        <div class="content" >
                                            ...
                                            <Progress :percent=value.number :status=value.state :stroke-width="8" style="padding-top: 10px;width:220px; "/>
           ...
           return{
               bzdata:[
                   ...
                   },
                   {
                       ...
                       team:"Angular",
                       title:'希望是一个好东西，也许是最好的，好东西是不会消亡的',
                       name:"曲丽丽",
